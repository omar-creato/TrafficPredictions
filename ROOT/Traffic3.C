...
//Initialisation Part
	...
	car[1][0].SetCarData(0,0,26,5);	
	car[2][0].SetCarData(0,0,33,5);
	car[3][0].SetCarData(0,0,40,5);
	...
	car[0][1].SetCarData(0,0,6,4);
	car[1][1].SetCarData(0,0,20,5);	
	car[2][1].SetCarData(0,0,31,5);
	car[3][1].SetCarData(0,0,40,5);
