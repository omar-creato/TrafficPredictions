...
//pos_time(1,:)=[5,N,N,N,N,N,N,4,N,N,N,N,5,N,N,N,N,N,2,N,N,0,0,N,1,N,N,N,0,N,N,N,3,N,N,N,N,N,5,N]
...
//Adding new cars
    if pos_time(t-1,1) == N &&  probability(alpha) == 1 then
//Maximum velocity should be Vmax, only if distance permits
        pos_time(t,1)=min(grand(1,1,"uin",1,d(t-1,1)*2),grand(1,1,"uin",0,Vmax))
    end
